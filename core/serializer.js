...
var Serializer = Montage.create(Montage, /** @lends module:montage/serializer.Serializer# */ {
    ...
    setUnit: {
        value: function(name) {
            ...
            if (stackElement.units.indexOf(name) === -1) {
                stackElement.units.push(this._serializationUnitsIndex[name]);
            }
        }
    },
    ...
    setAllUnits: {
        value: function() {
            ...
            stackElement.units.length = 0;
            stackElement.units.push.apply(stackElement.units, this._serializationUnits);
        }
    },
    ...
    _applyTypeUnit: {
        value: function(serializedUnits, object) {
            ...
            if (object instanceof RegExp || object instanceof Element || Array.isArray(object) || Object.getPrototypeOf(object) === Object.prototype || object.constructor === Function || !(typeOfObject === "object" || typeOfObject === "function")) {
    ...
    _serializeValue: {value: function(value, type) {
        var indent = arguments[2] || 0,
            ...
            canAccessValue = value != null;

        if (canAccessValue && typeof value.serializeSelf === "function") {
            ...
            } else if (canAccessValue && typeOfValue === "object" || typeOfValue === "function") {
    ...
    _customSerialization: {
        value: function(object, indent) {
            this._pushContextObject(object);
            this._pushContextObject({properties: {}, units: []});
