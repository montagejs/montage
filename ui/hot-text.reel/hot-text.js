...
/**
    @module "montage/ui/hot-text.reel"
...
/**
    ...
    @class module:"montage/ui/hot-text.reel".HotText
    @extends module:montage/ui/component.Component
 */
var HotText = exports.HotText = Montage.create(Component, /** @lends module:"montage/ui/hot-text.reel".HotText# */ {
    ...
    */
    ...
    /**
    The value of the HotText converted using {@link converter} for display.
    ...
    */
    ...
    /**
    The minimum value the HotText can take. If set to <code>null</code> there
    is no minimum.
    @type {number|null}
    @default null
    */
    ...
    /**
    The maximum value the HotText can take. If set to <code>null</code> there
    is no maximum.
    @type {number|null}
    @default null
    */
    ...
    */
    ...
    drags the HotText or presses the Up arrow in input mode.
    @type {number}
    @default 1
    */
    stepSize: {
