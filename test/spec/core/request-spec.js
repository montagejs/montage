...
describe("core/request-spec", function () {
    ...
    describe("makeOk", function () {
        ...
        it("resolves the response for 200 status", function (done) {
            response = {
                status: 200,
                headers: {},
                body: "pass"
            ...
            ok("http://example.com").then(function (response) {
        ...
        it("resolves the response for 204 status", function (done) {
            response = {
                status: 204,
                headers: {},
                body: "pass"
        ...
        it("rejects for 404 status", function (done) {
            response = {
                status: 404,
                headers: {},
    ...
    describe("makeJson", function () {
        ...
        describe("request", function () {
            it("sets Accept header to application/json", function (done) {
                json("http://example.com").then(function () {
            ...
            it("stringifies a given object", function (done) {
                json({
                    url: "http://example.com",
                    body: {pass: "yes"}
                }).then(function () {
            ...
            it("sets overrideMimeType to application/json", function (done) {
                json("http://example.com").then(function () {
            ...
            it("sets responseType to json", function (done) {
                json("http://example.com").then(function () {
        ...
        describe("response", function () {
            it("parses the response", function (done) {
                json("http://example.com").then(function (response) {
            ...
            it("gives an informative error when JSON parsing fails", function (done) {
                response.body = "x";
            ...
            it("has no body if there was no response body", function (done) {
    ...
    it("calls setRequestHeader with the headers", function (done) {
        object.headers = {
            one: "value 1",
            two: "value 2"
        };
