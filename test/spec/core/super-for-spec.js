        ...
        describe("constructors", function () {
            describe("with three in a row", function () {
                ...
                it("calling constructor on vehicle", function () {
                    vehicle = new Vehicle();
                    expect(vehicleConstructorSpy.calls.count()).toEqual(1);
                });
                it("calling constructor on car", function () {
                    car = new Car();
                    expect(vehicleConstructorSpy.calls.count()).toEqual(1);
                    expect(carConstructorSpy.calls.count()).toEqual(1);
                });
                it("calling constructor on beetle", function () {
                    beetle = new Beetle();
                    expect(vehicleConstructorSpy.calls.count()).toEqual(1);
                    expect(carConstructorSpy.calls.count()).toEqual(1);
                    expect(beetleConstructorSpy.calls.count()).toEqual(1);
                });
                it("calling constructor on vehicle twice", function () {
                    vehicle = new Vehicle();
                    vehicle = new Vehicle();
                    expect(vehicleConstructorSpy.calls.count()).toEqual(2);
                });
                it("calling constructor on car twice", function () {
                    car = new Car();
                    car = new Car();
                    expect(vehicleConstructorSpy.calls.count()).toEqual(2);
                    expect(carConstructorSpy.calls.count()).toEqual(2);
                });
                it("calling constructor on beetle twice", function () {
                    ...
                    expect(vehicleConstructorSpy.calls.count()).toEqual(2);
                    expect(carConstructorSpy.calls.count()).toEqual(2);
                    expect(beetleConstructorSpy.calls.count()).toEqual(2);
                });
            });
