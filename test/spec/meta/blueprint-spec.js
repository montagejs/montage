    ...
    describe("Blueprint", function () {
        ...
        describe("createDefaultBlueprintForObject", function () {
            ...
            it("has the correct module id for the parent", function (done) {
                var ComponentBlueprintTest1 = require("spec/meta/component-blueprint-test/component-blueprint-test-1.reel/component-blueprint-test-1").ComponentBlueprintTest1;
                Blueprint.createDefaultBlueprintForObject(ComponentBlueprintTest1).then(function (blueprint) {
