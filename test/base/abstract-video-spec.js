    ...
    describe("properties", function () {
        ...
        describe("mediaElement", function () {
            ...
            it("should have controller after creation", function() {
                expect(aVideoPlayer.mediaElement.controller).not.toBeNull();
            });
            
            it("should unlink native media controller when changed", function() {
                var oldMediaElement = aVideoPlayer.mediaElement;
                aVideoPlayer.mediaElement = MockDOM.element();
                expect(aVideoPlayer.videoController.mediaController).not.toEqual(oldMediaElement.controller);
            });

            it("should link native media controller to new element when changed", function() {
                var newMediaElement = MockDOM.element()
                aVideoPlayer.mediaElement = newMediaElement;
                expect(aVideoPlayer.videoController.mediaController).toEqual(newMediaElement.controller);
            });

            it("should link new native media controller when changed", function() {
                var newMediaController = {};
                aVideoPlayer.videoController = {
                    mediaController : newMediaController
                };
                expect(aVideoPlayer.mediaElement.controller).toEqual(newMediaController);
            });
        ...
        describe("videoController", function () {
            ...
            it("should unlink native media controller when changed", function() {
                var oldMediaController = aVideoPlayer.videoController.mediaController;
                aVideoPlayer.videoController = {
                    mediaController : {}
                };
                expect(aVideoPlayer.mediaElement.controller).not.toEqual(oldMediaController);
            });
